/**
 * Copyright &copy; 2015-2020 <a href="http://www.bbibm.com/">bbibmPlus</a> All rights reserved.
 */
...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
    ...
    public static String getBeforeTime(int day) {
        ...
        long time;
        if(day==0){
            time=System.currentTimeMillis() - day * 24 * 60 * 60 * 1000L-5*60*1000L;
        }else{
            time=System.currentTimeMillis() - day * 24 * 60 * 60 * 1000L;
        }
